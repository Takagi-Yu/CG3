...
ID3D12Resource* CreateTextureResource(ID3D12Device* device,
  ...
  HRESULT hr = device->CreateCommittedResource(
      ...
      D3D12_RESOURCE_STATE_GENERIC_READ, // しょかいのResourceState。Textureは基本読むだけ
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
  ...
  *materialData = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
  ...
  IDxcBlob *pixelShaderBlob = CompileShader(L"Object3D.PS.hlsl", L"ps_6_0", dxcUtils, dxcCompiler,
                    includeHandler, logStream);
